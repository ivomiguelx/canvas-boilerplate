...
function init() {
  balls = [];
  for (var i = 0; i < 400; i++) {
    var radius = _utils__WEBPACK_IMPORTED_MODULE_0___default().randomIntFromRange(8, 20);
    var x = _utils__WEBPACK_IMPORTED_MODULE_0___default().randomIntFromRange(0 + radius, canvas.width - radius);
    var y = _utils__WEBPACK_IMPORTED_MODULE_0___default().randomIntFromRange(0, canvas.height - radius);
    var dx = _utils__WEBPACK_IMPORTED_MODULE_0___default().randomIntFromRange(-2, 2);
